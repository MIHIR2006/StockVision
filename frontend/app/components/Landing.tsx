...
/**
 * Render the application's landing page with interactive sections, a sticky navbar, and smooth-scrolling helpers.
 *
 * The component provides scroll helpers (market data, yield curve, features, pricing, and top), a requestAnimationFrame-driven
 * scroll progress bar, sidebar state and interactions, a floating "Go to Top" control, and content sections for hero,
 * live market data, yield curve, features, pricing, testimonials, and footer. It exposes a window.scrollToPricing function
 * while mounted for external callers.
 *
