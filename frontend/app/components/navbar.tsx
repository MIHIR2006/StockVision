...
/**
 * Render the top navigation bar with branding, a theme toggle, and user authentication controls.
 *
 * @param onMenuClick - Callback invoked when the logo/menu area is clicked
 * @returns The header element containing the app title, theme toggle, and either an authenticated user dropdown or a sign-in call-to-action
 */
