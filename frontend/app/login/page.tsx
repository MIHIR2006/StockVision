...
/**
 * Render the login page UI and handle authentication flows, theme toggling, navigation, and related loading/error states.
 *
 * The component manages email/password and social sign-in (GitHub/Google), shows inline error and loading states, supports a password visibility toggle, a "Remember me" option, and a theme toggle that updates the document root class. It also navigates to dashboard, signup, forgot-password, or landing pages as appropriate.
 *
