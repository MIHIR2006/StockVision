...
export default function SignupPage() {
  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-background/80">
      <div className="w-full max-w-md mx-auto mt-20 p-8 bg-white/5 rounded-3xl shadow-2xl backdrop-blur-xl border border-white/10">
        <h1 className="text-3xl font-bold text-center text-white mb-8 drop-shadow-lg">Sign Up</h1>
        ...
        <div className="text-center mt-6 text-white/80">
          Already have an account? <button onClick={() => handleNavigation("/login")} className="text-blue-400 hover:text-blue-300 underline transition-colors">Login</button>
        </div>
      </div>
    </main>
  );
