"use client";
import { Eye, EyeClosed, Moon, Sun, StepBack, Mail, Lock, Github, Chrome, UserPlus, CheckCircle2, XCircle } from "lucide-react";
...
/**
 * Renders the signup page UI and manages signup, social sign-in, theme toggling, navigation, and password validation state.
 *
 * This component provides a form for email/password signup with live password policy feedback, handles submission to the signup API
 * (including auto-login on success), supports GitHub and Google sign-in flows, and exposes navigation and theme toggle controls.
 *
          ...
          <div className="bg-gray-50 dark:bg-gray-700/30 rounded-xl p-2.5 space-y-1">
            ...
            <div className="space-y-1">
              <div className="flex items-center gap-1.5">
                ...
                <span className={`text-xs ${passwordRules.minLength ? "text-green-600 dark:text-green-500 font-medium" : "text-gray-600 dark:text-gray-400"}`}>
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span className={`text-xs ${passwordRules.uppercase ? "text-green-600 dark:text-green-500 font-medium" : "text-gray-600 dark:text-gray-400"}`}>
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span className={`text-xs ${passwordRules.lowercase ? "text-green-600 dark:text-green-500 font-medium" : "text-gray-600 dark:text-gray-400"}`}>
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span className={`text-xs ${passwordRules.number ? "text-green-600 dark:text-green-500 font-medium" : "text-gray-600 dark:text-gray-400"}`}>
                  One number (0-9)
                </span>
              </div>
              <div className="flex items-center gap-1.5">
                ...
                <span className={`text-xs ${passwordRules.specialChar ? "text-green-600 dark:text-green-500 font-medium" : "text-gray-600 dark:text-gray-400"}`}>
